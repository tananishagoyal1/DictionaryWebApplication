...
const { updateImposter } = require("./mountebank-helper.js");

function addStubForCorrectWord(word)
{
    var response = [
        {
            "word": "test",
            ...
            "phonetics": [
                ...
                },
                {
                    ...
                    "sourceUrl": "https://commons.wikimedia.org/w/index.php?curid=1197419",
                    "license": {
                        "name": "BY-SA 3.0",
    ...
    return updateImposter({"stub":stubs});
}
function addStubForIncorrectWord(word)
{
    var response =
    {
...
module.exports= {addStubForCorrectWord,addStubForIncorrectWord};